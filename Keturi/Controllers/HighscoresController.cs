...
namespace Keturi.Controllers
{
    public class HighscoresController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nickname,Score")] Highscore highscore)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nickname,Score")] Highscore highscore)
        {
            if (ModelState.IsValid)
            {
